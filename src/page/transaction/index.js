    ...
    const columns = [
      {
        ...
        key: "type",
        width: 240,
        render: (oritext, record) => {
          // console.log(ori)
          const text = util.filterTag(oritext);
          return (
      ...
      },
      {
        ...
        dataIndex: "info",
        key: "info",
        render: (text, orirecord) => {
          console.log(JSON.stringify(orirecord.info));
          const record = JSON.parse(
            util.filterSysAcc(JSON.stringify(orirecord.info))
          );
          return (
            <ReactJson
              style={{
    ...
    return (
      <div className="transaction">
        ...
        <section className="info">
          ...
          <ReactJson
            src={JSON.parse(
              util.filterSysAcc(`${JSON.stringify(transaction)}`)
            )}
            collapsed={true}
            style={{
              wordBreak: "break-all",
